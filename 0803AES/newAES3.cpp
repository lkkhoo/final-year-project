...
int main(){
  ...
  //unsigned char key[16] = {34,65,12,43,2,11,3,6,3,2,8,32,72,22,10,10};
  unsigned char key[16] = {14,3,9,18,23,55,9,32,52,43,62,2,7,19,55,10};
  int length = arrayLength;
  int length2 = length;

  //unsigned char nonce[8] = {1,2,3,4,5,6,7,8};
  //unsigned char nonce[8] = {4,88,45,23,7,4,10,26};
  unsigned char nonce[8] = {66,28,39,37,11,19,25,9};
  ...
  cv::imwrite("C:/Users/khool/Desktop/FYP/0803AES/baboon_3rounds.png",encrypted);
  cv::waitKey(0);
